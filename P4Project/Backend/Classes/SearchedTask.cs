...
namespace P4Project.Backend.Classes
{
    ...
    class SearchedTask : TaskBase
    {
        ...
        public SearchedTask(int id, int smeID) : base(id, smeID)
        {
        ...
        public SearchedTask(int id, int smeID, string title, string location, int hours) : base(id, smeID)
        {
            Title = title;
            Location = location;
            Hours = hours;
